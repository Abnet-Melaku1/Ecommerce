          ...
          <div className='flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4'>
            ...
            <div className='hidden md:block'>
              <ul className='flex items-center space-x-6'>
                <Link
                  href='/'
                  className='dark:text-white dark:hover:text-gray-300 text-base text-right  focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline text-gray-800'>
                  Home
                </Link>
              </ul>
            </div>
            <div className='hidden md:flex items-center space-x-4'>
              ...
              <div className=''>
                <Link
                  href='/cart'
                  className='focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded flex items-center gap-1'>
                  <svg
                    className='fill-stroke text-gray-800 dark:text-white'
                    width={20}
                    height={22}
